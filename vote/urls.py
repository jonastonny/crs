...
urlpatterns = [
    ...
    url(r'^room/(?P<pk>[0-9]+)/$', cache_page(15)(views.RoomDetailView.as_view()), name='room_detail'),
    ...
    url(r'^room/(?P<room>[0-9]+)/group/(?P<pk>[0-9]+)/$', cache_page(15)(views.QuestionGroupDetailView.as_view()), name='questiongroup_detail'),
    ...
    url(r'^room/(?P<room>[0-9]+)/group/(?P<questiongroup>[0-9]+)/question/(?P<pk>[0-9]+)/$', cache_page(15)(views.QuestionDetailView.as_view()), name='question_detail'),
